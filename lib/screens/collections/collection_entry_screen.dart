  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Shop>>(
      ...
      builder: (context, snapshot) {
        ...
        final balanceAfter = (_selectedShop?.balance ?? 0) - (double.tryParse(_amountController.text.trim()) ?? 0);
                ...
                Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Outstanding before payment', style: Theme.of(context).textTheme.titleMedium),
                        const SizedBox(height: 8),
                        Text(AppFormatters.currency(_selectedShop?.balance ?? 0)),
                        const SizedBox(height: 18),
                        Text('Balance after payment', style: Theme.of(context).textTheme.titleMedium),
                        const SizedBox(height: 8),
                        Text(
                          AppFormatters.currency(balanceAfter < 0 ? 0 : balanceAfter),
